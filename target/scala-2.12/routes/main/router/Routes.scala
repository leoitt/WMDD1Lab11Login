...
class Routes(
  ...
  // @LINE:35
  private[this] lazy val controllers_HomeController_updateCustomer11_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("updateCustomer/"), DynamicPart("id", """[^/]+""",true)))
  )
  private[this] lazy val controllers_HomeController_updateCustomer11_invoker = createInvoker(
  ...
  // @LINE:38
  private[this] lazy val controllers_HomeController_deleteCustomer12_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("delCustomer/"), DynamicPart("id", """[^/]+""",true)))
  )
  private[this] lazy val controllers_HomeController_deleteCustomer12_invoker = createInvoker(
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    // @LINE:35
    case controllers_HomeController_updateCustomer11_route(params@_) =>
      call(params.fromPath[Long]("id", None)) { (id) =>
        controllers_HomeController_updateCustomer11_invoker.call(HomeController_0.updateCustomer(id))
      }
  
    // @LINE:38
    case controllers_HomeController_deleteCustomer12_route(params@_) =>
      call(params.fromPath[Long]("id", None)) { (id) =>
        controllers_HomeController_deleteCustomer12_invoker.call(HomeController_0.deleteCustomer(id))
      }
